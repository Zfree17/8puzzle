...
public class SearchTree {
    ...
    public void breadthFirstSearch() {
    	System.out.println("Start Searching: BF SEARCH: ");
...
//**********************************************************************************************
    ...
    public void depthFirstSearch() {
    	System.out.println("Start Searching: DF SEARCH: ");
        // stateSet is a set that contains node that are already visited
        Set<String> stateSets = new HashSet<String>();
        int totalCost = 0;
        int time = 0;
    ...
    public void uniformCostSearch() {
    	System.out.println("Start Searching: UNIFORM COST SEARCH: ");
        // stateSet is a set that contains node that are already visited
        Set<String> stateSets = new HashSet<String>();
        int totalCost = 0;
        int time = 0;
    ...
    public void aStar(Heuristic heuristic) {
    	System.out.println("Start Searching: A* SEARCH: ");
        // stateSet is a set that contains node that are already visited
        Set<String> stateSets = new HashSet<String>();
        int totalCost = 0;
        int time = 0;
    ...
    public void iterativeDeepening(int depthLimit) {
    	...
    	System.out.println("Start Searching: ID-DF SEARCH: ");
